class Hand
  ...
  def two_pair?
    rank_sets.size == 3 && most_common_rank_size == 2
  end

  def three_of_a_kind?
    rank_sets.size == 3 && most_common_rank_size == 3
  end
  ...
  def full_house?
    rank_sets.size == 2 && most_common_rank_size == 3
  end

  def four_of_a_kind?
    rank_sets.size == 2 && most_common_rank_size == 4
  end
  ...
  def wraparound_straight?
    ranks = rank_sets
    ranks.size == 5 && ranks[3] == 5 && ranks[4] == 14
  end

  def all_consecutive?
    ranks = rank_sets
    ranks.size == 5 && ranks[4] - ranks[0] == 4
  end
